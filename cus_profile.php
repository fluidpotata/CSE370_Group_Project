...
<body>
    ...
    <p>
        ...
        <span id="cusID"><?php echo $row[0]['cusID'] ?></span>
      </p>
      <p>
        <span class="infos">Name:</span>
        <span class="infos"><?php echo $row[0]['fname'].' '.$row[0]['lname'] ?></span>
      </p>
      <p>
        <span class="infos">Phone:</span>
        <span class="infos"><?php echo $row[0]['phone'] ?></span>
      </p>
      <p>
        <span class="infos">Email:</span>
        <span class="infos"><?php echo $row[0]['email'] ?></span>
      </p>
      <p>
        <span class="infos">Address:</span>
